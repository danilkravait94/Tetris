...
namespace Tetris
{
    class Program
    {
        ...
        public static ConsoleKeyInfo key,k;
        ...
        public static void Doings()
        {
            ...
            if (Program.key.Key == ConsoleKey.Escape & isKeyPressed)
            {
                splayer.Stop();
                for (int i = 0; i < 1000; i++)
                {
                    ...
                    {
                        k = Console.ReadKey();
                        if (Program.key.Key == ConsoleKey.Escape)
                        {
                            splayer.Play(); splayer.SoundLocation = Environment.CurrentDirectory + "\\01. Main Menu.wav";
